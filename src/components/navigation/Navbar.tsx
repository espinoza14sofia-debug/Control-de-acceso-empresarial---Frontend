                    ...
                    {usuario && (
                        <div ref={menuRef} className="relative">
                            ...
                            {menuAbierto && (
                                <div
                                    role="menu"
                                    className="absolute right-0 z-40 mt-2 w-56 overflow-hidden rounded-xl border border-ink-300/50 bg-white py-1 shadow-lg"
                                >
                                    <div className="border-b border-ink-300/30 px-4 py-3 md:hidden">
                                        <p className="truncate text-sm font-semibold text-ink-900">{usuario.full_name}</p>
                                        <p className="mt-0.5 truncate text-xs text-ink-400">{ETIQUETA_ROL[usuario.role]}</p>
                                    </div>
